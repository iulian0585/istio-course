...
# SSM policy to the node group role
...
module "eks" {
  ...
  eks_managed_node_groups = {
    spot = {
      ...
      #instance_types = ["m7a.medium", "m7i-flex.large", "m6i.large", "m6a.large", "m5.large", "m5a.large"]
      ...
      vpc_security_group_ids = [
        aws_security_group.istio_ports.id,
